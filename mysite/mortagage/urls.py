...
urlpatterns=[
	...
	path('Yearly_Mortagage_Balance/',views.Yearly_Mortagage_Balance,name='Yearly_Mortagage_Balance'),
	path('fabonacci_number/',views.fabonacci_number,name='Fabonacci_Number'),
